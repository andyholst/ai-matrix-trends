...
def main():
    ...
    plugins_to_create = [
        ...
        # --- Extended MCP servers (2026 landscape) ---
        {
            "title": "Slack MCP",
            "tags": ["plugin", "mcp"],
            "agents": ["202609202000 - Claude Code", "202609200759 - Hermes Agent", "202609200758 - OpenCode"],
        ...
        },
        {
            ...
            "tags": ["plugin", "mcp"],
            "agents": ["202609202000 - Claude Code", "202609200759 - Hermes Agent", "202609200758 - OpenCode", "202609202000 - Cursor"],
