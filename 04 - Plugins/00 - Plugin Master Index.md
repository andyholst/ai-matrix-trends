...
tags:
  ...
  - index
links:
  - "[[04 - Plugins/202609200803 - Context7 MCP.md]]"
  - "[[04 - Plugins/202609200804 - FAL MCP Server.md]]"
  - "[[04 - Plugins/202609200805 - Hermes Kanban Dashboard.md]]"
  - "[[04 - Plugins/202609200806 - Hermes Curator.md]]"
  - "[[04 - Plugins/202609200807 - Claude Code Auto Permission.md]]"
  - "[[04 - Plugins/202609200920 - Vercel Agent Browser.md]]"
  - "[[04 - Plugins/202609200921 - OpenCode Morph Fast Apply.md]]"
  - "[[04 - Plugins/202609200922 - OpenCode Ensemble.md]]"
  - "[[04 - Plugins/202609200923 - OpenCodeRAG.md]]"
  - "[[04 - Plugins/202609200924 - OpenCode Chromium Browser.md]]"
  - "[[04 - Plugins/2026092020 - GitHub MCP Server.md]]"
  - "[[04 - Plugins/2026092020 - Superpowers.md]]"
  - "[[04 - Plugins/202609202000 - Browser Use MCP.md]]"
  - "[[04 - Plugins/202609202000 - Firecrawl MCP Server.md]]"
  - "[[04 - Plugins/202609202000 - Jev Agent Router.md]]"
  - "[[04 - Plugins/202609202000 - OpenCode Firecrawl.md]]"
  - "[[04 - Plugins/202609202000 - OpenCode Supermemory.md]]"
  - "[[04 - Plugins/202609202010 - Playwright MCP.md]]"
  - "[[04 - Plugins/202609202011 - Chrome DevTools MCP.md]]"
  - "[[04 - Plugins/202609202012 - OpenCode Dynamic Context Pruning.md]]"
  - "[[04 - Plugins/202609202013 - Hermes Plugin System.md]]"
  - "[[04 - Plugins/202609202014 - OpenCode Oh-My-Openagent.md]]"
  - "[[04 - Plugins/202609202025 - Exa MCP.md]]"
  - "[[04 - Plugins/202609202035 - Supabase MCP.md]]"
  - "[[04 - Plugins/202609202045 - Notion MCP.md]]"
  - "[[04 - Plugins/202609202055 - Linear MCP.md]]"
  - "[[04 - Plugins/2026092021 - Oh My OpenAgent.md]]"
  - "[[04 - Plugins/2026092021 - Sentry MCP.md]]"
  - "[[04 - Plugins/202609202105 - Figma MCP.md]]"
  - "[[04 - Plugins/202609202115 - Stripe MCP.md]]"
  - "[[04 - Plugins/202609202125 - Cloudflare MCP.md]]"
  - "[[04 - Plugins/202609202135 - Datadog MCP.md]]"
  - "[[04 - Plugins/202609202145 - Kubernetes MCP.md]]"
  - "[[04 - Plugins/202609202155 - Terraform MCP.md]]"
  - "[[04 - Plugins/2026092022 - Browserbase MCP.md]]"
  - "[[04 - Plugins/2026092022 - Composio MCP.md]]"
  - "[[04 - Plugins/202609202205 - Sequential Thinking MCP.md]]"
  - "[[04 - Plugins/202609202215 - Zapier MCP.md]]"
  - "[[04 - Plugins/202609202225 - Hermes Jev Agent Router.md]]"
  - "[[04 - Plugins/2026092023 - Claude Code Code Review.md]]"
  - "[[04 - Plugins/2026092023 - CodeGraph MCP.md]]"
  - "[[04 - Plugins/2026092024 - OpenCode Snip.md]]"
  - "[[04 - Plugins/2026092024 - Sourcegraph MCP.md]]"
...
|---|--------|-------|-------|--------|-------------|
| 1 | [Context7 MCP](./202609200803%20-%20Context7%20MCP.md) | 255 | — | Aider, Claude Code, Codex +9 | Context7 is an open-source Model Context Protocol server bui... |
| 2 | [FAL MCP Server](./202609200804%20-%20FAL%20MCP%20Server.md) | 255 | — | Aider, Claude Code, Codex +9 | FAL MCP Server is a hosted Model Context Protocol endpoint t... |
| 3 | [Browser Use MCP](./202609202000%20-%20Browser%20Use%20MCP.md) | 255 | — | Aider, Claude Code, Codex +9 | Browser Use MCP is a local Model Context Protocol server tha... |
| 4 | [Firecrawl MCP Server](./202609202000%20-%20Firecrawl%20MCP%20Server.md) | 255 | — | Aider, Claude Code, Codex +9 | The official Firecrawl MCP Server brings web scraping, crawl... |
...
|---|--------|-------|-------|--------|-------------|
| 1 | [Context7 MCP](./202609200803%20-%20Context7%20MCP.md) | 255 | — | Heating Up | Context7 is an open-source Model Context Protocol server built by Upstash that g... |
...
| 4 | [Firecrawl MCP Server](./202609202000%20-%20Firecrawl%20MCP%20Server.md) | 255 | — | Heating Up | The official Firecrawl MCP Server brings web scraping, crawling, and search capa... |
| 5 | [GitHub MCP Server](./2026092020%20-%20GitHub%20MCP%20Server.md) | 135 | — | Heating Up | GitHub's official MCP Server exposes repository, issue, pull request, Actions, a... |
| 6 | [CodeGraph MCP](./2026092023%20-%20CodeGraph%20MCP.md) | 95 | — | Heating Up | CodeGraph is an MCP server that converts your codebase into a knowledge graph, e... |
| 7 | [Exa MCP](./202609202025%20-%20Exa%20MCP.md) | 75 | — | Heating Up | Exa MCP is a semantic search engine purpose-built for AI agents. |
| 8 | [Supabase MCP](./202609202035%20-%20Supabase%20MCP.md) | 75 | — | Heating Up | Supabase MCP is the official Model Context Protocol server for the Supabase plat... |
| 9 | [Notion MCP](./202609202045%20-%20Notion%20MCP.md) | 75 | — | Heating Up | Notion MCP is the official Model Context Protocol server for Notion workspaces. |
| 10 | [Linear MCP](./202609202055%20-%20Linear%20MCP.md) | 75 | — | Heating Up | Linear MCP is a Model Context Protocol server that connects AI coding agents to ... |
| 11 | [Oh My OpenAgent](./2026092021%20-%20Oh%20My%20OpenAgent.md) | 75 | — | Heating Up | Oh My OpenAgent (omo) is a batteries-included agent harness for OpenCode (and a ... |
| 12 | [Figma MCP](./202609202105%20-%20Figma%20MCP.md) | 75 | — | Heating Up | Figma MCP is the official Model Context Protocol server for Figma. |
| 13 | [Stripe MCP](./202609202115%20-%20Stripe%20MCP.md) | 75 | — | Heating Up | Stripe MCP is the official Model Context Protocol server for Stripe. |
| 14 | [Cloudflare MCP](./202609202125%20-%20Cloudflare%20MCP.md) | 75 | — | Heating Up | Cloudflare MCP is the official Model Context Protocol server for the Cloudflare ... |
| 15 | [Datadog MCP](./202609202135%20-%20Datadog%20MCP.md) | 75 | — | Heating Up | Datadog MCP is the official Model Context Protocol server for Datadog's unified ... |
| 16 | [Kubernetes MCP](./202609202145%20-%20Kubernetes%20MCP.md) | 75 | — | Heating Up | Kubernetes MCP is a community-maintained Model Context Protocol server that give... |
| 17 | [Terraform MCP](./202609202155%20-%20Terraform%20MCP.md) | 75 | — | Heating Up | Terraform MCP is the official Model Context Protocol server from HashiCorp for T... |
...
*All plugins/extensions for Aider — 4 total*
...
*All plugins/extensions for Gemini CLI — 4 total*
...
| 4 | [Firecrawl MCP Server](./202609202000%20-%20Firecrawl%20MCP%20Server.md) | 255 | — | Heating Up | The official Firecrawl MCP Server brings web scraping, crawling, and search capa... |
| 5 | [GitHub MCP Server](./2026092020%20-%20GitHub%20MCP%20Server.md) | 135 | — | Heating Up | GitHub's official MCP Server exposes repository, issue, pull request, Actions, a... |
| 6 | [Oh My OpenAgent](./2026092021%20-%20Oh%20My%20OpenAgent.md) | 75 | — | Heating Up | Oh My OpenAgent (omo) is a batteries-included agent harness for OpenCode (and a ... |
| 7 | [Claude Code Auto Permission](./202609200807%20-%20Claude%20Code%20Auto%20Permission.md) | 40 | — | Stable | Auto Permission is a Claude Code permission mode introduced in v2. |

### Kilo Code

*All plugins/extensions for Kilo Code — 4 total*
...
*All plugins/extensions for RooCode — 4 total*
...
*All plugins/extensions for JetBrains Junie — 4 total*
...
|---|--------|-------|-------|--------|
| 1 | [Vercel Agent Browser](./202609200920%20-%20Vercel%20Agent%20Browser.md) | 60 | — | Claude Code, Cursor |
| 2 | [OpenCode Chromium Browser](./202609200924%20-%20OpenCode%20Chromium%20Browser.md) | 20 | — | OpenCode |
...
| # | Plugin | Score | Stars | Agents |
|---|--------|-------|-------|--------|
| 1 | [Context7 MCP](./202609200803%20-%20Context7%20MCP.md) | 255 | — | Aider, Claude Code |
| 2 | [FAL MCP Server](./202609200804%20-%20FAL%20MCP%20Server.md) | 255 | — | Aider, Claude Code |
| 3 | [Browser Use MCP](./202609202000%20-%20Browser%20Use%20MCP.md) | 255 | — | Aider, Claude Code |
| 4 | [Firecrawl MCP Server](./202609202000%20-%20Firecrawl%20MCP%20Server.md) | 255 | — | Aider, Claude Code |
...
| # | Plugin | Score | Stars | Agents |
|---|--------|-------|-------|--------|
| 1 | [Hermes Plugin System](./202609202013%20-%20Hermes%20Plugin%20System.md) | 40 | — | Hermes Agent, OpenCode |
| 2 | [Hermes Jev Agent Router](./202609202225%20-%20Hermes%20Jev%20Agent%20Router.md) | 40 | — | Claude Code, Hermes Agent |
...
|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|--------|-------|
| [Context7 MCP](./202609200803%20-%20Context7%20MCP.md) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 255 |
| [FAL MCP Server](./202609200804%20-%20FAL%20MCP%20Server.md) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 255 |
| [Browser Use MCP](./202609202000%20-%20Browser%20Use%20MCP.md) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 255 |
| [Firecrawl MCP Server](./202609202000%20-%20Firecrawl%20MCP%20Server.md) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | 255 |
...
| [Exa MCP](./202609202025%20-%20Exa%20MCP.md) | ✅ | — | — | ✅ | ✅ | — | — | — | — | — | — | — | 75 |
| [Supabase MCP](./202609202035%20-%20Supabase%20MCP.md) | ✅ | — | — | ✅ | ✅ | — | — | — | — | — | — | — | 75 |
| [Notion MCP](./202609202045%20-%20Notion%20MCP.md) | ✅ | — | — | ✅ | ✅ | — | — | — | — | — | — | — | 75 |
| [Linear MCP](./202609202055%20-%20Linear%20MCP.md) | ✅ | — | — | ✅ | ✅ | — | — | — | — | — | — | — | 75 |
